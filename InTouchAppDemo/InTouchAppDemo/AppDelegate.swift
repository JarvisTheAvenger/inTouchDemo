...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let path = Bundle.main.path(forResource: "ListModel", ofType: "realm")

        print(path ?? "")
        print(defaultPath ?? "")

        print(!FileManager.default.fileExists(atPath: defaultPath!))
        ...
        let realm = try! Realm()
        let array = Array(realm.objects(ListModel.self))
        print(array.count)
